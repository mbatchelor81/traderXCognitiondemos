...
import { AccountSummaryStatistics } from "../Datatable/types";
...
/**
 * Fetches aggregated trade statistics for the selected account.
 * Refreshes whenever the account or tenant changes.
 */
export const GetAccountSummary = (accountId: number, refreshKey?: unknown) => {
