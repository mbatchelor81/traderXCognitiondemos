...
export const Datatable = () => {
	...
	const { summary: accountSummary, refetch: refetchSummary } = GetAccountSummary(selectedId);
			...
			{/* Summary stat cards */}
				...
				<Grid container spacing={2} sx={{ mb: 3 }}>
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							title="Total Trades"
							value={accountSummary.statistics.totalTrades}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							...
							value={accountSummary.statistics.settledTrades}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							...
							value={accountSummary.statistics.pendingTrades}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							title="Net Quantity"
							value={accountSummary.statistics.netQuantity}
