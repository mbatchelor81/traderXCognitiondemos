...
export const Datatable = () => {
	...
	const { data: summaryStats, refetch: refetchSummary } = GetAccountSummary(selectedId);
	const refetchSummaryRef = useRef(refetchSummary);
	useEffect(() => { refetchSummaryRef.current = refetchSummary; }, [refetchSummary]);
			...
			{hasAccount && (
				<Grid container spacing={2} sx={{ mb: 3 }}>
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							title="Net Quantity"
							value={summaryStats.netQuantity}
