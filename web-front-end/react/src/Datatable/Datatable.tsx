			...
			{hasAccount && (
				<Grid container spacing={2} sx={{ mb: 3 }}>
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							title="Total Trades"
							value={accountSummary?.totalTrades ?? tradeRowData.length}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							...
							value={accountSummary?.settledTrades ?? 0}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							...
							value={accountSummary?.pendingTrades ?? 0}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							title="Net Quantity"
							value={(accountSummary?.netQuantity ?? 0).toLocaleString()}
