...
export const Datatable = () => {
	...
	const summaryData = GetAccountSummary(selectedId, summaryRefreshKey);
				...
				<Grid container spacing={2} sx={{ mb: 3 }}>
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							...
							value={summaryData?.statistics.settledTrades ?? 0}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							...
							value={summaryData?.statistics.pendingTrades ?? 0}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							title="Net Quantity"
							value={summaryData?.statistics.netQuantity ?? 0}
