			...
			{hasAccount && (
				<Grid container spacing={2} sx={{ mb: 3 }}>
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							title="Total Trades"
							value={accountSummary?.statistics.totalTrades ?? tradeRowData.length}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							...
							value={accountSummary?.statistics.settledTrades ?? 0}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							...
							value={accountSummary?.statistics.pendingTrades ?? 0}
					...
					<Grid item xs={12} sm={6} md={3}>
						<StatCard
							title="Net Quantity"
							value={(accountSummary?.statistics.netQuantity ?? 0).toLocaleString()}
