...
def get_account_summary(account_id: int, request: Request,
    ...
    Returns total trades, settled/pending counts, buy/sell volumes, and net quantity.
    Leverages the existing get_account_portfolio_summary() function in trade_processor.
    """
    tenant_id = get_tenant_from_request(request)
    ...
    log_audit_event("ACCOUNT_SUMMARY", tenant_id,
